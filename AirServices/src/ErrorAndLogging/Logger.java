	...
	public static Logger getLogger()
	{
		if(logger==null)
		{
			synchronized(Logger.class)
			{
				...
				if(logger==null)
				{
					// And this ones even more interesting. The reason for this double check is because
					...
					// Now B waits for the lock. When A finishes, B still enters the synchronized and 
